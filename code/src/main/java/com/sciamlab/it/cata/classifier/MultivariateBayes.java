...
public class MultivariateBayes implements Classifier{

	private TrainingSet trainingSet;
	private FeatureExtractor fe;
	
	public MultivariateBayes(TrainingSet trainingSet, FeatureExtractor featureExtractor){
	...
	private Map<Theme, Double> termsProd(List<String> corpus){
		...
		Map<Theme, Integer> sumsTf = trainingSet.getSumDF();
		Map<String, Map<Theme, Integer>> tf=trainingSet.getDf();
