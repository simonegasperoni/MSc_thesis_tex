...
La versione corrente di JRC-Acquis è la 3.0, i vantaggi che possiamo trarre utilizzando JRC-Acquis per la catalogazione di open data sono molteplici. Acquis rilascia periodicamente nuove versioni di corpus indicizzati con i descrittori di EuroVoc.

\begin{enumerate}
\item Standard TEI
\item Corpus aggiornato e manutenuto
\item Corpus multilingua
\item Bridge dinamico tra i concetti e le categorie
\end{enumerate}
...
\subsubsection{Bridge dinamico tra i concetti e le categorie}
\begin{figure}[htbp]
\begin{center}
...
Nella tabella che segue sono riportate le corrispondenze tra i 13 temi definiti nell'ambito di DCAT-AP (utili per documentare la proprietà  tema della classe Dataset) e i concetti disponibili nel vocabolario EUROVOC.
