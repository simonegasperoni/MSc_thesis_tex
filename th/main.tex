...
\end{figure}
\\
L'uso congiunto della rappresentazione dei dati DCAT-AP-it ed un portale web accessibile mediante API \say{standard} è una strategia di base per garantire l'interoperabilità dei dataset. Le pubbliche amministrazioni europee utilizzano CKAN (standard de facto) per la gestione dei propri dataset.
\\
