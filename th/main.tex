...
Gli open-data sono i dati delle pubbliche amministrazioni e dei privati che intendono renderli disponibili per diversi scopi, gli aspetti più importanti della filosofia open-data sono:
\begin{itemize}
...
\\
\\
Il tesauro EuroVoc viene utilizzato dalle istituzioni dell'Unione europea, dall'Ufficio delle pubblicazioni dell'UE, da parlamenti nazionali e regionali in Europa, come pure da amministrazioni nazionali e utenti privati di tutto il mondo.
\footnotemark
...
\\
\\
Ogni entry dell'array \say{retrains} individua un gruppo di dataset di un \say{publisher} e aventi  determinati \say{tags}, ogni dataset diventa l'equivalente di un documento di Acquis nel quale le categorie DCAT sono riportate nel campo \say{categories}, i termini si estraggono dai metadati testuali disponibili, ovvero, titolo, tag e descrizione.
\\
\\
